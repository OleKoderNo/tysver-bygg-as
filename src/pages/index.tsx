  ...
  return (
    <main className="">
      ...
      <section className="py-8 px-4">
        <div className="md:w-11/12 lg:w-3/4 md:mx-auto flex flex-col lg:flex-row items-center gap-8">
          <div>
            <Image
              src="/suitman.png"
              width={500}
          ...
          <div>
            ...
            <p>
              ...
              innen bolig- og næringsbygg. Vi leverer skreddersydde løsninger
              for ethvert prosjekt.
            </p>
            <p>
              selskapet ble grunnlagt i 2010 av erfarne håndverkere som ønsklet
              å tilby høy kvalitet og ålitelighet til lokalsamfunnet. Siden den
              gang har vi bygget et solid rykte.
            </p>
            <TextLinkButton
      ...
      <section className="py-8 px-4 bg-gray-200">
        <div className="grid md:w-11/12 lg:w-3/4 md:mx-auto gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <p className="col-span-full text-center mb-4">
            Utforsk vårt utvalg av bygg- og rehabiliteringstjenester
      ...
      <section className="px-4">
        <div className="md:w-11/12 lg:w-3/4 md:mx-auto">
          ...
          <div>
            <p>
              Tysvær Bygg AS leverte et fantastisk resultat på vårt nybygg. De
              var profesjonelle, punktlige og veldig hjelopsomme gjennom hele
              prosessen!
            </p>
            <div>
              <p>Ola Hansen</p>
          ...
          <div>
            <div className="border-t border-gray-300 mx-3" />
            <p>
              Vi er veldig fornøyd med rehabiliteringen av vår eldre bolig.
              Tysvær Bygg AS gjorde en utmerket jobb og overgikk våre
              forventinger.
            </p>
            <div>
              <p>Kari Nilsen</p>
